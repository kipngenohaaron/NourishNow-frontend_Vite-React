...
const Events = () => {
  const [events, setEvents] = useState([
    {
      id: 1,
      title: 'Burudani Palace',
      description:
        'Join us for Event at Burudani Palace, where we come together to make a positive impact on the lives of needy children. Your support in the form of funds, food, and more is greatly appreciated!',
      date: '2023-10-10',
